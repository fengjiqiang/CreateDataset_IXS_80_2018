...
if __name__ == '__main__':
    trainset = IXS(root='../IXS_80_2018')
    print(len(trainset.train_img))    # 3462
    print(len(trainset.train_label))  # 3461 ?
    # for data in trainset:
        # print(data[0].size(), data[1])
    # testset = IXS(root='../IXS_80_2018', is_train=False)
    # print(len(testset.test_img))    # 3295
    # print(len(testset.test_label))  # 3295
    # for data in testset:
    #     print(data[0].size(), data[1])
